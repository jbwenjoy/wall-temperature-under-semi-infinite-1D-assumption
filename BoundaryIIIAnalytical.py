...
def single_iteration(num_of_nodes, step_x, step_time, a, tem_cur_time, air_tem):
    ...
    for i in range(num_of_nodes):
        if i == 0:  # 第一个节点，对流换热边界
            ...
            continue
        if i == num_of_nodes - 1:  # 最后一个节点，恒温边界
            tem_next_time[i] = far_boundary_const_tem(
...
if __name__ == "__main__":
    ...
    plt.scatter(time_array, boundary_tem, 0.01, label="Boundary temperature")
    plt.scatter(time_array, air_tem, 0.01, label="Mainstream temperature")
